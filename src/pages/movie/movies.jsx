...
class SelectCell extends Component {
    ...
    render() {
        if(this.props.selected){
            return <li><button className="moviestate selected">{this.props.value}</button></li>
        }else{
            return <li>
            <button  className="moviestate" onClick={()=>this.changeMovieState(this.props.index)}>{this.props.value}</button>
            </li>
        }
    }
...
class TagCell extends Component{
    ...
    render() {
        if(this.props.selected){
            ...
            return <button className="tag" onClick={()=>this.changeMovieState(this.props.index)}>{this.props.value}</button>
        }
    }
}
